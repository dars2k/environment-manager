...
| github.com/bytedance/sonic/loader | v0.5.1 | v0.5.2 | No |
...
- Ensured proper promise error handling when mocking component submissions (`OtherPages.test.tsx`) by wrapping asynchronous form submissions inside a `try...catch` block to completely swallow rejected promises, preventing any unhandled promise rejections during testing.

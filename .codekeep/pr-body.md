...
| github.com/pelletier/go-toml/v2 | v2.3.1 | v2.4.0 | No |
| github.com/quic-go/quic-go | v0.59.1 | v0.60.0 | No |
| go.mongodb.org/mongo-driver/v2 | v2.6.0 | v2.6.1 | No |
...
| axios | 1.15.2 | 1.18.0 | No |
| react-router-dom | 6.30.3 | 6.30.4 | No |

## Unit Test Coverage

Maintain unit test coverage threshold of 90%.

- **Baseline:** 92.3% (statements)
- **Current:** 92.3% (statements)

Substantive tests were added for:
- Backend: `internal/service/environment`, `internal/service/ssh`
- Frontend: `EnvironmentForm` component

## QA Fixes

- Resolved a TODO in `backend/internal/api/handlers/environment.go`: Updated `List` handler and `environment.Service` to return total count for paginated environment lists.
- Updated repository interfaces and mocks to support total count retrieval.

## Checklist

- [x] All tests pass (`make test`)
- [x] Unit test coverage ≥ 90%
- [x] Breaking changes addressed/documented
